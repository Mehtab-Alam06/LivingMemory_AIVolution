  ...
  return (
    <motion.div layout initial={{ opacity:0, y:16 }} animate={{ opacity:1, y:0 }}
      ...
      <div ref={menuRef} onDoubleClick={() => setShowMenu(m => !m)}
        ...
        {msg.text && <p style={{ fontFamily:"'Cormorant Garamond',serif", fontSize:15, color:'#353535', lineHeight:1.6, margin:0 }}>{msg.text}</p>}
        <AnimatePresence>
          {showMenu && (
