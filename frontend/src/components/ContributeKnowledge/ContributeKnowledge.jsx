...
export default function ContributeKnowledge() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      setError(err.response?.data?.errors?.[0] || err.response?.data?.error || "Submission failed. Please try again.");
    }
    setSubmitting(false);
  };
  ...
  // ── Shared styles matching AuthPage ──
  const inp = {
    ...
    fontSize: 17, outline: "none", marginBottom: 14, transition: "border-color .2s, box-shadow .2s"
  };
  ...
  const contactFooter = (
    <div style={{ marginTop: 40, textAlign: "center" }}>
      <div style={{ borderTop: "1px solid rgba(155,107,47,.15)", paddingTop: 20, marginBottom: 10 }}>
        <div style={{ fontFamily: "Space Mono,monospace", fontSize: 9, letterSpacing: ".14em", color: "rgba(212,171,99,.35)", textTransform: "uppercase", marginBottom: 10 }}>
          Need Help? Contact Us
        </div>
        <div style={{ fontFamily: "Cormorant Garamond,serif", fontSize: 15, color: "rgba(212,171,99,.55)", lineHeight: 1.8 }}>
          📧 livingmemory104@gmail.com<br />
          📍 GIFT, Bhubaneswar, Odisha, India<br />
          🌐 Living Memory — AI Knowledge Preservation
        </div>
      </div>
      ...
      <div style={{ maxWidth: 520, margin: "0 auto", padding: "40px 20px" }}>
        ...
        <div style={{ animation: "ckIn .5s ease", textAlign: "center" }}>
          ...
          <div style={{
            ...
            <div style={{ textAlign: "center", padding: "18px 0 0", color: "rgba(155,107,47,.42)", fontSize: 13, letterSpacing: 7 }}>✦ ❧ ✦</div>

            <div style={{ padding: "28px 38px 32px" }}>
              <h2 style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 26, color: "#3a2010", fontWeight: "normal", margin: "0 0 8px" }}>
              ...
              <div style={{ display: "inline-block", padding: "14px 28px", background: "rgba(155,107,47,.08)", border: "1px dashed rgba(155,107,47,.3)", borderRadius: 6, marginBottom: 20 }}>
                <div style={{ fontFamily: "Space Mono,monospace", fontSize: 9, letterSpacing: ".14em", color: "rgba(92,51,23,.45)", textTransform: "uppercase", marginBottom: 6 }}>
                  Tracking ID
                </div>
                <div style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 24, color: "#7b4c1a", letterSpacing: ".04em" }}>
                  {trackingId}
                </div>
              </div>
              ...
              <div>
                <button onClick={reset} style={{
                  width: "100%", padding: "13px", background: "linear-gradient(135deg,#9b6b2f,#7b4c1a)",
                  border: "none", borderRadius: 4, color: "#f5edd8", fontFamily: "IM Fell DW Pica,serif",
                  fontSize: 18, cursor: "pointer", boxShadow: "0 4px 18px rgba(155,107,47,.3)", transition: "all .2s"
                }}>
                  ← Back to Dashboard
                </button>
              </div>
            ...
            <div style={{ textAlign: "center", padding: "0 0 16px", color: "rgba(155,107,47,.35)", fontSize: 13, letterSpacing: 7 }}>✦ ❧ ✦</div>
          </div>
        </div>
        {contactFooter}
      </div>
            ...
            {stepLabels.map((l, i) => (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 6 }}>
                <div style={{
                  ...
                  background: i <= step ? "rgba(155,107,47,.2)" : "rgba(212,171,99,.08)",
                  border: `2px solid ${i <= step ? "#9b6b2f" : "rgba(212,171,99,.2)"}`,
                  color: i <= step ? "#d4ab63" : "rgba(212,171,99,.3)",
                  transition: "all .3s", boxShadow: i === step ? "0 0 10px rgba(212,171,99,.25)" : "none"
                }}>
                  {i < step ? "✓" : i + 1}
                </div>
                <span style={{
                  fontFamily: "Space Mono,monospace", fontSize: 9, letterSpacing: ".08em",
                  color: i <= step ? "rgba(212,171,99,.65)" : "rgba(212,171,99,.25)", textTransform: "uppercase"
                }}>{l}</span>
            ...
            <div style={{ padding: "24px 34px 28px" }}>
              ...
              {step === 0 && (<>
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  ...
                  <h3 style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 22, color: "#3a2010", fontWeight: "normal", margin: 0 }}>
                    Your Details
                  </h3>
                  <p style={{ fontFamily: "Cormorant Garamond,serif", fontSize: 14, color: "rgba(92,51,23,.5)", fontStyle: "italic", margin: "5px 0 0" }}>
                ...
                <div style={row}>
                  <div>
                    ...
                    <input className="ck-inp" style={inp} value={form.name} onChange={e => set("name", e.target.value)} />
                  </div>
                  <div>
                    <label style={lbl}>Email</label>
                    <input className="ck-inp" style={inp} type="email" value={form.email} onChange={e => set("email", e.target.value)} />
                  </div>
                </div>
                <div style={row}>
                  <div>
                    <label style={lbl}>Phone <span style={{ opacity: .4 }}>(optional)</span></label>
                    <input className="ck-inp" style={inp} type="tel" value={form.phone} onChange={e => set("phone", e.target.value)} placeholder="+91..." />
                  </div>
                  <div>
                    <label style={lbl}>Country</label>
                    <input className="ck-inp" style={inp} value={form.country} onChange={e => set("country", e.target.value)} placeholder="e.g. India" />
                  </div>
                </div>
              ...
              {step === 1 && (<>
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  ...
                  <p style={{ fontFamily: "Cormorant Garamond,serif", fontSize: 14, color: "rgba(92,51,23,.5)", fontStyle: "italic", margin: "5px 0 0" }}>
                    Tell us about the knowledge you wish to preserve
                  </p>
                </div>
                ...
                <textarea className="ck-inp" style={{ ...ta, minHeight: 70 }} value={form.description} onChange={e => set("description", e.target.value)} placeholder="A short summary of what this knowledge is about..." />

                <div style={row}>
                  <div>
                    <label style={lbl}>Domain <span style={{ color: "#b03020" }}>*</span></label>
                    <select className="ck-inp" style={sel} value={form.domain} onChange={e => set("domain", e.target.value)}>
                      <option value="">Select...</option>
                      {DOMAINS.map(d => <option key={d} value={d}>{d}</option>)}
                    </select>
                  </div>
                  <div>
                    <label style={lbl}>Ownership <span style={{ color: "#b03020" }}>*</span></label>
                    <select className="ck-inp" style={sel} value={form.ownershipType} onChange={e => set("ownershipType", e.target.value)}>
                      <option value="">Select...</option>
                ...
                <div style={row}>
                  <div>
                    <label style={lbl}>Region Practiced</label>
                    <input className="ck-inp" style={inp} value={form.knowledgeRegion} onChange={e => set("knowledgeRegion", e.target.value)} placeholder="e.g. Western Odisha" />
                  </div>
                  <div>
                    <label style={lbl}>Age of Knowledge</label>
                    <select className="ck-inp" style={sel} value={form.knowledgeAge} onChange={e => set("knowledgeAge", e.target.value)}>
                      <option value="">Select...</option>
                      <option value="<50 years">Less than 50 years</option>
                      <option value="50-100 years">50–100 years</option>
                      <option value="100-500 years">100–500 years</option>
              ...
              {/* ── STEP 2: Explanation & Permissions ── */}
              {step === 2 && (<>
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  <div style={{ fontSize: 30, marginBottom: 6 }}>✍</div>
                  <h3 style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 22, color: "#3a2010", fontWeight: "normal", margin: 0 }}>
              ...
              <div style={{ display: "flex", gap: 10, marginTop: 6 }}>
                {step > 0 && (
                  <button onClick={prev} style={{
                    flex: 1, padding: "13px", background: "rgba(155,107,47,.08)",
                    border: "1px solid rgba(155,107,47,.25)", borderRadius: 4,
                    color: "#7b4c1a", fontFamily: "IM Fell DW Pica,serif", fontSize: 17,
                ...
                {step < 2 ? (
                  <button onClick={next} style={{
                    ...
                    fontFamily: "IM Fell DW Pica,serif", fontSize: 18,
                    cursor: "pointer", boxShadow: "0 4px 18px rgba(155,107,47,.3)", transition: "all .2s"
                  }}>Next Step →</button>
                ) : (
                  <button onClick={submit} disabled={submitting} style={{
                    flex: 1, padding: "13px",
                    background: submitting ? "rgba(155,107,47,.3)" : "linear-gradient(135deg,#9b6b2f,#7b4c1a)",
                    border: "none", borderRadius: 4, color: "#f5edd8",
                    fontFamily: "IM Fell DW Pica,serif", fontSize: 18,
                    cursor: submitting ? "not-allowed" : "pointer",
                    boxShadow: submitting ? "none" : "0 4px 18px rgba(155,107,47,.3)", transition: "all .2s"
                  }}>
    ...
    <div style={{ maxWidth: 560, margin: "0 auto", padding: "32px 20px" }}>
      ...
      <div style={{ animation: "ckIn .4s ease" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: 28 }}>
          ...
          <div style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 34, color: "#f0e8d8", lineHeight: 1.1, marginBottom: 6, textShadow: "0 0 40px rgba(212,171,99,.25)" }}>
            Contribute <em style={{ color: "#d4ab63", fontStyle: "normal" }}>Knowledge</em>
          </div>
          <div style={{ fontFamily: "Cormorant Garamond,serif", fontSize: 16, color: "rgba(237,224,190,.5)", lineHeight: 1.7, maxWidth: 440, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", padding: "14px 0 0", color: "rgba(155,107,47,.42)", fontSize: 13, letterSpacing: 7 }}>✦ ❧ ✦</div>
          ...
          <div style={{ textAlign: "center", padding: "0 0 12px", color: "rgba(155,107,47,.35)", fontSize: 13, letterSpacing: 7 }}>✦ ❧ ✦</div>
        </div>

        {/* Previous Submissions */}
        {submissions.length > 0 && (
          <div style={{
            background: "rgba(212,171,99,.05)", border: "1px solid rgba(212,171,99,.12)",
            borderRadius: 6, padding: "16px 20px", marginBottom: 12
          }}>
            <h4 style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 16, color: "rgba(237,224,190,.7)", fontWeight: "normal", margin: "0 0 12px" }}>
              📋 Your Submissions
            </h4>
            {submissions.map(s => (
              <div key={s._id} style={{
                ...
                border: "1px solid rgba(212,171,99,.08)", borderRadius: 4, marginBottom: 6
              }}>
                <div>
                  <div style={{ fontFamily: "IM Fell DW Pica,serif", fontSize: 15, color: "#e8d8b8" }}>{s.knowledgeTitle}</div>
                  <div style={{ fontFamily: "Space Mono,monospace", fontSize: 9, color: "rgba(212,171,99,.35)", marginTop: 2 }}>
                ...
                <span style={{
                  ...
                  background: s.submissionStatus === "Approved" ? "rgba(109,184,109,.15)" : s.submissionStatus === "Rejected" ? "rgba(208,94,82,.15)" : "rgba(232,160,32,.15)",
                  color: s.submissionStatus === "Approved" ? "#6db86d" : s.submissionStatus === "Rejected" ? "#d05e52" : "#e8a020"
                }}>
                  {s.submissionStatus}
                </span>
              </div>
